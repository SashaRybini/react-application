...
const ChatRoom: React.FC = () => {
    ...
    useEffect(() => {
        if (userData) { //иначе идет реконнект без юзердаты
            if (!messagesService.isWebsocket()) { //потому что колится раньше апп..
    ...
    function handleMessage(event: any) {
        ...
        if (message.from) { //там выше также будут сообщ о коннекте.. странно кстати что как мессадж тайп проходит
