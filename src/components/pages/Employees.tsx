...
const Employees: React.FC = () => {
    ...
    async function actualRemove(isOk: boolean) {
        ...
        if (isOk) {
            try {
                ...
                dispatch('', `empl ${employeeId.current} has been deleted`)
            } catch (error: any) {
                errorMessage = error;
    ...
    async function actualUpdate(isOk: boolean) {
        ...
        if (isOk) {
            try {
                ...
                dispatch('', `empl ${employeeId.current} has been updated`)
            } catch (error: any) {
                errorMessage = error
                dispatch(errorMessage, '');
            }
    ...
    return <Box sx={{
        ...
        <Confirm handleClose={confirmFn.current} open={openConfirm}
